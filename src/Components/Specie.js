        ...
        : <React.Fragment>
            <div className="flex">
              ...
              <div className="col-sm-2">
                {
                  favourite
                  ? <img src={like} className="likeBtn" alt="like btn" onClick={() => {this.props.favourite("species", this.props.specie.id, false); this.setState({favourite: false})}} />
                  : <img src={unlike} className="unlikeBtn" alt="unlike btn" onClick={() => {this.props.favourite("people", this.props.person.id, true); this.setState({favourite: true})}} />
                }
              </div>
            </div>
